...
if __name__ == '__main__':
    try:
        ...
        Assignment3.saveTable('parallelSortOutputTable', 'parallelSortOutputTable.txt', con);
        ...
        a = raw_input("Check in database and once you are done, press enter to delete all tables: ");
        Assignment3.saveTable('parallelJoinOutputTable', 'parallelJoinOutputTable.txt', con);
        deleteTables('ALL', con);
